...
namespace Ticari_Otomasyon
{
    public partial class FrmGiderler : Form
    {
        ...
        void giderListesi()
        {
            ...
            da.Fill(dt); //data adapter ile veritabanından verileri çekip datatable'a doldurduk
            gridControl1.DataSource = dt; //datagrid'e datatable'ı veri kaynağı olarak atadık
        }
