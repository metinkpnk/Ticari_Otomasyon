...
namespace Ticari_Otomasyon
{
    public partial class FrmKasa : Form
    {
        ...
        void faturaBilgileri()
        {
            ...
            SqlDataAdapter da1 = new SqlDataAdapter("Select * From TBL_GIDERLER", bgl.baglanti());
            da1.Fill(dt3);
        ...
        private void FrmKasa_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand komut6 = new SqlCommand("Select Count(Distinct(IL)) From TBL_FIRMALAR", bgl.baglanti()); //tekrarsız say demek.
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            {
                groupControl11.Text = "Doğalgaz Faturası";
                chartControl2.Series["Aylar"].Points.Clear();
                SqlCommand komut11 = new SqlCommand("Select top 4 AY,DOGALGAZ From TBL_GIDERLER Order By ID Desc", bgl.baglanti());
                SqlDataReader dr11 = komut11.ExecuteReader();
                while (dr11.Read())
